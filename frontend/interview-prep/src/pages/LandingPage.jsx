        ...
        <div className="w-[500px] h-[500px] bg-amber-200/20 blur-[65px] absolute top-0 left-0" />
          <div className=" container mx-auto px-4 pt-6 pb-[200px] relative z-10 ">
            ...
            <header className="flex justify-between items-center mb-16">
              ...
              {user ? (<ProfileInfoCard/>):(<button className="bg-linear-to-r from-[#FF9324] to-[#e99a4b] text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-black hover:text-white border border-white transition-colors cursor-pointer " onClick={()=> setOpenAuthModal(true)}>Login/SignUp</button>)}
            </header>
            ...
            <div className="flex flex-col md:flex-row items-center ">
              <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
                ...
                <h1 className="text-5xl text-black font-medium mb-6 leading-tight ">
                  ...
                  <span className="text-transparent bg-clip-text bg-[radial-gradient(circle,_#FF9324_0%,_#e99a4b_100%)] bg-[length:200%_200%] animate-text-shine font-semibold">
                    AI Powered
                  </span>{" "}
                  Learning
                </h1>
              ...
              <div className="w-full md:w-1/2">
                <p className="text-[17px] text-gray-900 mr-0 md:mr-20 mb-6">
                  Get role specific interview questions, expand answers when you need them, 
                  dive deeper into concepts and organize everything in your way.
                  From preparation to mastery-you're ultimate preparation toolkit is here.
                </p>
